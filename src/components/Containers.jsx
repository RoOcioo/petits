...
<div className="containerP1">
                    <div className="divchildP1">
                      <div >
                        {this.props.circleColor}={this.state.player1Tokens[0] ? "#4646e8" : "black"} 
                        {this.props.circleColor}={this.state.player1Tokens[1] ? "#4646e8" : "black"} 
                      <div/>

                      <div >
                      {this.props.circleColor}={this.state.player1Tokens[2] ? "#4646e8" : "black"} 
                      {this.props.circleColor}={this.state.player1Tokens[3] ? "#4646e8" : "black"} 
                      </div>
                    </div>
                  </div>
